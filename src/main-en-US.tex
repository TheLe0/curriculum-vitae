...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in September 2024}\hspace{\widthof{Last updated in Jun 2025}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \section{About}
        ...
        \begin{onecolentry}
            I started my career in software development in 2017 and have since worked continuously as a Full Stack Software Engineer. Over the years, I’ve gained experience with a wide range of technologies and product types, giving me a solid understanding of the entire software development lifecycle of a product.
            
            My core expertise lies in .NET, Java, Angular, and cloud platforms like AWS and Azure. I'm particularly experienced in building high-performance, low-latency applications that handle large volumes of data.
            
            One of my main areas of interest is database systems — both SQL and NoSQL. I enjoy diving deep into their internal mechanisms to better understand how their engines work and how to optimize them for different use cases.
    ...
    \section{Links}
        \begin{onecolentry}
            \begin{highlightsforbulletentries}
                \item \href{https://leotosin.com.br/}{Personal website}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item I work across the entire platform development lifecycle, from front-end implementations and improvements for a more user-friendly UI to back-end optimizations ensuring high performance and scalability.
                \item I also contribute to multiple areas including Cloud, DevOps, FinOps, SRE, Observability, and database maintenance/optimization.
                \item Some key contributions from my work:
                \begin{highlightsforbulletentries}
                    \item Actively participated in compliance efforts to achieve SOC 2 and SOC 3 certifications by implementing security enhancements requested by AWS Security Hub and a Disaster Recovery strategy for regional failover.
                    \item Implemented SSO (Single Sign-On) and SCIM (System for Cross-domain Identity Management) to enable integration with IdPs such as Active Directory, Okta, Google, and Amazon, supporting bidirectional sync of users and groups.
                    \item Developed a document search mechanism combining Full Text Search and Semantic Search to allow sub-second search across millions of documents.
                    \item Built AI-powered features for document classification, analysis, and summarization based on contextual knowledge bases.
                    \item Created robust connectors for enterprise systems like SAP, Salesforce, and Box, enabling cross-platform integrations.
                \end{highlightsforbulletentries}
                \item Tools Used: C\#, .NET, .NET Framework, Java, MongoDb, AWS, Apache Lucene, Serverless, API Gateway, AWS S3, Vector Search and Python.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \textit{\href{https://www.edrian.com.br/}{edrian.com.br}}}
            \textbf{Engenheiro Edrian}
        \end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item A website for a engineer consultancy
                \item Tools Used: Angular 17, Azure Static Web Apps and Mailgun.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C\#, Java/Kotlin, JS/TS and PHP
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Frameworks:} .NET, Quarkus and Laravel
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Cloud:} Azure and AWS
        \end{onecolentry}

        \vspace{0.2 cm}
    
        \begin{onecolentry}
            \textbf{Databases:} SQL Server, MongoDb, CosmosDb, Redis, MySQL and PostgreSQL
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Messaging:} Apache Kafka, AWS SQS and Azure Service Bus
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Infrastructure:} Terraform, Azure Biceps, AWS CDK, Docker, Kubernetes, AWS Lambda and Azure Functions
        \end{onecolentry}
